...
class VegetablesControllerTest < ActionController::TestCase
  ...
  test "should create vegetable" do
    assert_difference('Vegetable.count') do
      post :create, vegetable: { id: @vegetable.id, name: @vegetable.name, r_name: @vegetable.r_name, serial: @vegetable.serial }
    end
  ...
  test "should update vegetable" do
    patch :update, id: @vegetable, vegetable: { id: @vegetable.id, name: @vegetable.name, r_name: @vegetable.r_name, serial: @vegetable.serial }
    assert_redirected_to vegetable_path(assigns(:vegetable))
  end
